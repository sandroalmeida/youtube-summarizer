package io.professionalhub.scraper.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "io.professionalhub.scraper.repository")
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("io.professionalhub.scraper.model");
